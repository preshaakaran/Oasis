    ...
    <>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/cabins' element={<ProtectedRoute><Cabins cabins={cabins} /></ProtectedRoute>} />
          <Route path='/about' element={<ProtectedRoute><About /></ProtectedRoute>} />
          <Route path='/guest' element={<ProtectedRoute><Guest /></ProtectedRoute>}/>
          <Route path='/cabins/:id' element={<ProtectedRoute><CabinDetails cabins={cabins}/></ProtectedRoute>} />
